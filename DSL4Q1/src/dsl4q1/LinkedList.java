...
public class LinkedList<T extends Comparable<T>> {
    ...
    //to sort the linked list //Pls remember
    public void addSortNode(T t){
        ...
        if(head==null){
            ...
            while(currentNode!=null){
                if((currentNode.getData().compareTo(t)>0) && (previousNode.getData().compareTo(t)<=0)){
                    addNodeByPosition(t,i);
                    break;
                }
                else if(currentNode.getData().compareTo(t)<=0 && currentNode.getLink()==null){
                    addNode(t);
                    break;
                }
                previousNode = currentNode;
