...
//    public void randomNum(int quantity, int range){
//        Random r = new Random();
//        int[] ranNum = new int[quantity];
//        for(int i=1; i<=ranNum.length; i++){
//            ranNum[i] = r.nextInt(range);
//            System.out.print(addNode(ranNum[i]));
//        }
//        
//    }
...
//    }
    ...
    //delete given number in the list
    public void delete(int num){
        ListNode currentNode = head;
        for(int i=0; i<length(); i++){
        //while(currentNode!=null){
            if((Integer)currentNode.getData()==num){
