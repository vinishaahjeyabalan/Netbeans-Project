...
public class LinkedList<T extends Comparable<T>> {
    ...
    public void display(){                           //method to display the linkedlist
        ...
        while(currentNode != null){
            System.out.println(currentNode.toString()); //what does currentNode.get() mean?
            currentNode = currentNode.getLink();      //each time traversing the currentNode is set to the latest accessed node
        }
    }
    ...
    public void addAfter(String after, String now, int creditHr){
        int count=1;
        //String [] c = after.split("\\s");
        //System.out.println("Adding "+now+" after "+after);
